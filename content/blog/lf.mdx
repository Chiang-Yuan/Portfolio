...
Lattice Spring Model (LSM), one of the most common coarse-grained methods, is able to simulate the fracture of elastic body in a good agreement with fracture mechanics and continuum theorem. 

import Video from "../../src/components/video"

<Video
  videoSrcURL="https://www.youtube.com/embed/v9kyQaycz1o"
  videoTitle="Predict Mode I Fracture of Composites by Lattice Spring Model"
/>
